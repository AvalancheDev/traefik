...
docker tag containous/traefik-base-image containous/traefik-base-image:docker_$DOCKER_VERSION
docker push containous/traefik-base-image:docker_$DOCKER_VERSION
